    ...
    <>
      ...
      <div className="min-h-screen bg-white py-6 flex flex-col justify-center sm:py-12">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          {/* <div className="absolute inset-0 bg-gradient-to-r from-white to-white shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div> */}
          <div className="text-white relative px-4 py-10 bg-sky-100 shadow-lg sm:rounded-3xl sm:p-20">
            <div className="text-center pb-6">
              {isSubmitted ? (
                ...
                <>
                  <h1 className="text-3xl text-blue-900">Contact Us!</h1>
