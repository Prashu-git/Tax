    ...
    return (
        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-2xl font-bold mb-4 text-center">Service Policy</h1>
                <div className="prose lg:prose-xl">
                    <section className="mb-8">
                        <p>o
                            ...
                            governs the manner in which taxmarg.com collects, uses, maintains and discloses information collected from users (each, a "User") of the www.taxmarg.com website ("Site"). This privacy policy applies to the Site and all products and services offered by TaxMarg.
                        </p>
                        <br />
